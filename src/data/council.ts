...
export const councilOfficers: CouncilOfficer[] = [
  ...
  { id: "revenue-architect", emoji: "💸", name: "REVENUE ARCHITECT", role: "Income Systems Strategist", division: "Income Division", personalityStyle: "Originality-focused, experiment-driven, platform-aware", watches: "Etsy, Fiverr, affiliate, digital product, and creative workflow experiments", currentSignal: "Revenue Intelligence is read-only and Unknown-first.", recommendation: "Prioritize opportunities only when demand, margin, and experiment evidence exist.", confidence: "Medium", evidenceSource: "INCOME_DIVISION_STATUS.md", status: "Read-Only" },
