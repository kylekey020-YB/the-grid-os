...
export const councilOfficers: CouncilOfficer[] = [
  ...
  { id: "sentinel", emoji: "🛡️", name: "SENTINEL", role: "Risk & Safety Officer", division: "Safety", personalityStyle: "Conservative, constraint-aware, precise", watches: "Execution bans, secret exposure, platform compliance", currentSignal: "Revenue Intelligence must not become marketplace automation.", recommendation: "Block autonomous publishing, auto-DMs, purchasing, account automation, and fabricated metrics.", confidence: "High", evidenceSource: "Mission directive", status: "Read-Only" },
  ...
  { id: "revenue-architect", emoji: "💸", name: "REVENUE ARCHITECT", role: "Revenue Corps Commander", division: "Revenue Corps", personalityStyle: "Originality-focused, experiment-driven, platform-aware", watches: "Scout Corps, Product Corps, Launch Corps, opportunity ranking, and revenue experiments", currentSignal: "Revenue Intelligence is read-only and Unknown-first.", recommendation: "Prioritize opportunities only when demand, margin, and experiment evidence exist.", confidence: "Medium", evidenceSource: "REVENUE_CORPS_STATUS.md", status: "Read-Only" },
  ...
  { id: "gauntlet", emoji: "🧪", name: "GAUNTLET", role: "Research & Validation Officer", division: "Gauntlet Lab", personalityStyle: "Methodical, falsification-oriented", watches: "Backtests, assumptions, validation quality", currentSignal: "Experiments need hypothesis, evidence, decision, owner, and result.", recommendation: "Do not score or scale opportunities until evidence is present.", confidence: "High", evidenceSource: "Research doctrine", status: "Read-Only" },
